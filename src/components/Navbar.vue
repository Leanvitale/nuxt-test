    ...
    <header class="bg-white fixed w-full top-0 z-40 drop-shadow-sm">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <PopoverGroup class="hidden lg:flex lg:gap-x-12">
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900">{{ $t('navbar.features') }}</a>
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900">{{ $t('navbar.pricing') }}</a>
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900">{{ $t('navbar.contact') }}</a>
            </PopoverGroup>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900"
                    >{{ $t('navbar.sign-in') }} <span aria-hidden="true">&rarr;</span></a
                >
            </div>
        </nav>
