<template>
    <div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-dark px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        ...
        <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p class="text-sm leading-6 text-white">
                <strong class="font-semibold">{{ $t('banner.first') }}</strong
            ...
            <NuxtLink
                ...
                >{{ $t('banner.cta') }} <span aria-hidden="true">&rarr;</span></NuxtLink
            >
        </div>
